...
const DEFAULT_SETTINGS = {
    ...
    BOT_NAME: process.env.BOT_NAME || "𝐀𝐓𝐀𝐒𝐒𝐀-𝐌𝐃",
    FOOTER: process.env.BOT_NAME ? `ᴘᴏᴡᴇʀᴇᴅ ʙʏ ${process.env.BOT_NAME}` : "ᴘᴏᴡᴇʀᴇᴅ ʙʏ ꜱɪɢᴍᴀ ᴍᴅx",
    CAPTION: process.env.BOT_NAME ? `©2025 ${process.env.BOT_NAME}` : "©2025 𝐀𝐓𝐀𝐒𝐒𝐀-𝐌𝐃 𝐕𝟓",
    ...
    PACK_NAME: "𝐀𝐓𝐀𝐒𝐒𝐀-𝐌𝐃",
    PACK_AUTHOR: process.env.OWNER_NAME || "SIGMA-MDX",
    SUDO_NUMBERS: "",
    PM_PERMIT: "false",
    ANTIVIEWONCE: "indm",
};
